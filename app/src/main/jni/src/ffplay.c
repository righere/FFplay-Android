...
#define FF_ALLOC_EVENT (SDL_USEEVENT)
#define FF_REFRESH_EVENT (SDL_USEREVENT + 1)
#define FF_QUIT_EVENT    (SDL_USEREVENT + 2)
#define CV_PLAYER_SEEK   (SDL_USEREVENT	+ 3)
#define CV_PLAYER_PAUSE  (SDL_USEREVENT	+ 4)
#define CV_PLAYER_BUFCHK (SDL_USEREVENT	+ 5)
...
static int upload_texture(SDL_Texture *tex, AVFrame *frame, struct SwsContext **img_convert_ctx) {
    ...
    switch (frame->format) {
        case AV_PIX_FMT_YUV420P:
            ...
            ret = SDL_UpdateYUVTexture(tex, NULL, frame->data[0], frame->linesize[0], //Y
...
static int video_open(VideoState *is)
{
    ...
    if (!window) {
        ...
        window = SDL_CreateWindow(window_title, SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, w, h, SDL_WINDOW_RESIZABLE|SDL_WINDOW_FULLSCREEN|SDL_WINDOW_OPENGL);
